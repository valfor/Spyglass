...
try:
	testReq = urllib.request.Request('https://www.nationstates.net/cgi-bin/api.cgi?nation=' + UAgent.replace(' ', '_') + "&q=influence", None, headers)
...
urllib.request.urlretrieve('http://www.nationstates.net/pages/regions.xml.gz', 'regions.xml.gz')
